<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">
        <img src="img/logo_small.png" class="me-2" height="44px" width="54px" alt="" loading="lazy" />
        <small class="pl-4"><b>SPARK BANK</b></small>
      </a>
	  ...
	  <ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="viewalluser.php">Customer</a>
				</li>
				<li class="nav-item">
